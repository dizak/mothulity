...
mothulity /home/travis/build/dizak/mothulity/test_data/new_run/mltp_smpl/fastq/ -n analysis_travis_job --output-dir /home/travis/build/dizak/mothulity/ --analysis-only -r bash
